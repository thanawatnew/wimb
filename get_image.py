...
def get_pictures(cookies):
	...
	for id in list_cam_id:
		id=str(id)	
		#file_name_list = []
		for round in xrange(1): #collect three pictures from BMATRAFFIC
			...
			#time.sleep(1) # delay 1.5 second each time before collect a picture
		cascade = cv2.CascadeClassifier(path+"/models/cascade_bus_front_175_stages_1000_pos_3000_neg.xml")#"/models/cascade_wimb_bus_front_33_stages_1000_pos_3000_neg_wrong.xml")
